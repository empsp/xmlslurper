...
import org.xs4j.xmlslurper.XMLSlurperFactory;
...
public class InternalSpitterIT {
    ...
    public void givenInputXMLWithSchemaExtractAPartIntoNewXMLWithForeignNamespaceDefinitionIncluded() throws Exception {
        ...
        String actualXML = getXMLData(streamCaptor.getAllValues());
        String expectedXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><other:OtherObject other:attr3=\"123\" xmlns:other=\"http://other\"><OtherObject xmlns=\"http://general\" attr2=\"OTHER =123,OTHER_OBJECT= 124\"></OtherObject><OtherObject xmlns=\"http://general\" other:attr2=\"OTHER = 123,OTHER_OBJECT = 125\" xmlns:other=\"http://other\"></OtherObject></other:OtherObject>";
        assertThat(actualXML, is(expectedXML));
    }
